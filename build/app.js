...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "App","app",0,"app.core.js","es5-build-disabled.js","hydrated","app-home,app-profile,app-root,card-component,ion-app,ion-back-button,ion-button,ion-buttons,ion-card,ion-card-content,ion-card-header,ion-card-subtitle,ion-card-title,ion-col,ion-content,ion-grid,ion-header,ion-icon,ion-input,ion-item,ion-label,ion-nav,ion-ripple-effect,ion-route,ion-router,ion-row,ion-title,ion-toggle,ion-toolbar,random-list",HTMLElement.prototype);